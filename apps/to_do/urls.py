...
from apps.to_do.views import home,monitortemp,sensordata,receive_data,plot_view,deletar_dados,peso_view,deletar_dados_peso,get_temperatura_data,grafico_temperatura
urlpatterns = [ 
    path('', home, name='home'),
